...
const JobDetailsCard = ({id,gender,jobRole,age,carerrLevel,education,jobType,experience,salary}) => {
  return (
    <div>
    <div className=' w-full py-4  border-gray-300 border-[3px]  shadow-2xl  rounded-md border-l-primary   border-l-[6px] max-w-lg bg-secondary items-center '>
        ...
        <div className='flex flex-col gap-5 p-5 m-5  '>
            ...
            <div className=' py-4 border-b-2 border-gray-300 flex flex-row gap-5 px-3'>
                ...
                <p > {education}</p>
                <p className='text-primary font-bold'>Job Type:</p>
                <p> {jobType}</p>
            </div>
            <div className=' py-4 border-b-2 border-gray-300 flex flex-row gap-5 px-3'>
