...
const appliedJobCard = ({ jobTitle, companyName, status, img, id }) => {
  return (
    ...
    <div className=' border-b-2 border-b-gray-300 flex flex-row gap-2 items-center max-w-sm w-full border-gray-300 border-[3px] p-4 border-l-primary  border-l-[6px]  shadow-xl  rounded-md'>
      <Link href={`job/${id}`}>
