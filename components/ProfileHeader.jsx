...
const ProfileHeader = ({Fname,Lname,age,nationality,gender,militaryStatus,workCite, jobLevel, currentJobStatus, experience,phone ,email}) => {
  return (
    <div className=' px-5 w-[100%] m-auto py-4  border-gray-300 border-[3px]  shadow-2xl  rounded-md border-l-primary  border-l-[6px] max-w-[1000px] bg-secondary items-center'>
        <div className=' flex flex-row items-center gap-2'>
            <Image width={300} height={300} className=' w-28 h-28 rounded-full' src={gender=="Male"?boy:girl}/>
        ...
        <h3 className=' pb-2 text-lg font-bold'>Career Information</h3>
            <div className='  flex flex-col'>
            <ul>
                <li className='pb-2 text-primary font-bold'>Work Cities: <span className='text-black font-[600]'>{workCite}</span></li>
