...
const ProfileCard = ({name,gender,Address,educationlevel,yearsOFExperience,age}) => {
  return (
    <div>
        <div className=' border-b-2 border-b-gray-300 flex flex-row gap-2 items-center max-w-md border-gray-300 border-[3px] p-4 border-l-primary  border-l-[6px]  shadow-xl  rounded-md'>
            <Image width={300} height={300} className='w-32 h-32 rounded-full' src={gender=="Male"?male:female}/>
